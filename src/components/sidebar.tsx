  ...
  return (
    <div className="bg-gray-800 fixed">
      <div
        ...
        className="h-screen w-max flex-col px-8  shadow justify-between hidden sm:flex"
      >
        <div className="w-full">
          ...
          <ul className="mt-12">
            {menuList.map(({ href, label, icon: Icon, submenus }, index) => (
              ...
              >
                <Icon size={18} />
                <li className="flex w-full text-gray-300 cursor-pointer justify-between mb-6">
        ...
        <div className="px-8 border-t border-gray-700">
          <ul className="w-full gap-7 flex items-center justify-between bg-gray-800">
